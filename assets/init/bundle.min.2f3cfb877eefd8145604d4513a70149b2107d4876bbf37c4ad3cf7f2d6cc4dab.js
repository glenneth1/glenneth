(() => {
  ...
  // ns-params:@params
  var params_default = { author: [{ email: "glenn@kirstol.org", name: "Glenn Thompson" }], baseURL: "http://localhost:1313/", breadcrumb: true, carouselpostcount: 5, color: "auto", counttaxonomyposts: false, customcss: [], customjs: [], dateformat: ":date_long", description: "A Europeans' experience in the Middle East", diagram: false, featuredpostcount: 5, fixedheader: true, fullwidth: false, mainsections: ["posts", "docs"], math: true, palette: "blue", palettes: ["blue", "blue gray", "brown", "cyan", "green", "indigo", "orange", "pink", "purple", "red", "teal", "yellow"], pinnedpost: true, pinnedpostcount: 1, postdate: true, poweredby: true, readingtime: true, recentpostcount: 5, relatedpostcount: 5, searchbar: true, showfootercredits: true, sidebartaxonomies: ["series", "categories", "tags", "authors"], taxonomypaginate: 10, taxonomypostcount: 3, titlecase: false, titleseparator: "-", tocwordcount: 280, useicon: true, viewer: true };

  // ns-hugo:/home/glenn/blog/themes/bootstrap/assets/js/local-storage/index.ts
  ...
  // ns-hugo:/home/glenn/blog/themes/bootstrap/assets/js/mode/index.ts
  var MODE_AUTO = "auto";
  var MODE_DARK = "dark";
  ...
  // ns-hugo:/home/glenn/blog/themes/bootstrap/assets/js/palettes/index.ts
